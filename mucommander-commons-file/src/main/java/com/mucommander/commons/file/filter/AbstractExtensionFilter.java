 ...
 */
@BUG MediumPriority - jowk (2 of 2) ->|
@BUG MediumPriority - jowk (2 of 2) ->|package com.mucommander.commons.file.filter;
...
public class AbstractExtensionFilter extends AbstractStringCriterionFilter {
     ...
     */
@BUG LowPriority - yzjo (1 of 3) ->|    public AbstractExtensionFilter(CriterionValueGenerator<String> generator, String[] extensions, boolean caseSensitive, boolean inverted) {
@BUG LowPriority - yzjo (1 of 3) ->|        super(generator, caseSensitive, inverted);
@BUG LowPriority - yzjo (1 of 3) ->|
