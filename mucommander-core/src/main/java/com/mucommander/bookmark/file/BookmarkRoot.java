 ...
 */
@BUG MediumPriority - sioo (2 of 2) ->|
@BUG MediumPriority - sioo (2 of 2) ->|package com.mucommander.bookmark.file;
 ...
 */
@BUG LowPriority - fpxp (1 of 3) ->|class BookmarkRoot extends ProtocolFile implements BookmarkListener {
@BUG LowPriority - fpxp (1 of 3) ->|    // - Instance fields -------------------------------------------------------
@BUG LowPriority - fpxp (1 of 3) ->|    // -------------------------------------------------------------------------
