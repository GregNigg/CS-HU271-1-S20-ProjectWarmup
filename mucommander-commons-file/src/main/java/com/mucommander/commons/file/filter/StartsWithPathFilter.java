 ...
 */
@BUG LowPriority - ugha (3 of 3) ->|
@BUG LowPriority - ugha (3 of 3) ->|
@BUG LowPriority - ugha (3 of 3) ->|package com.mucommander.commons.file.filter;
...
public class StartsWithPathFilter extends AbstractStartsWithFilter implements PathFilter {
     ...
     */
@BUG HighPriority - wvsb (1 of 1) ->|    public StartsWithPathFilter(String s, boolean caseSensitive) {
