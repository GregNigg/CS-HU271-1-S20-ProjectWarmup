 ...
 */
@BUG LowPriority - vxao (3 of 3) ->|
@BUG LowPriority - vxao (3 of 3) ->|package com.mucommander.desktop;
@BUG LowPriority - vxao (3 of 3) ->|
...
@BUG HighPriority - ljpl (1 of 1) ->|        target = FileFactory.getFile(url.toString());
