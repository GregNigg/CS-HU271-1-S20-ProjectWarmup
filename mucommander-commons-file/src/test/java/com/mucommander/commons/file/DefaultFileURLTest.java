 ...
 */
@BUG MediumPriority - roan (2 of 2) ->|
@BUG MediumPriority - roan (2 of 2) ->|package com.mucommander.commons.file;
...
@BUG LowPriority - nlwh (1 of 3) ->|
@BUG LowPriority - nlwh (1 of 3) ->|    @Override
@BUG LowPriority - nlwh (1 of 3) ->|    protected AuthenticationType getAuthenticationType() {
