 ...
 */
@BUG LowPriority - qflv (3 of 3) ->|
@BUG LowPriority - qflv (3 of 3) ->|package com.mucommander.commons.conf;
@BUG LowPriority - qflv (3 of 3) ->|
/**
...
public class ConfigurationEvent {
     ...
     */
@BUG HighPriority - ivxk (1 of 1) ->|    public ConfigurationEvent(Configuration configuration, String name, String value) {
        this.name          = name;
        this.value         = value;
     ...
     */
@BUG MediumPriority - wxwm (1 of 2) ->|    public String getVariable() {
@BUG MediumPriority - wxwm (1 of 2) ->|        return name;
    }
