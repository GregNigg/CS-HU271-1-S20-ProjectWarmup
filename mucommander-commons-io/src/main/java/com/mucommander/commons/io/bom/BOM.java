 ...
 */
@BUG MediumPriority - wxkw (2 of 2) ->|
@BUG MediumPriority - wxkw (2 of 2) ->|package com.mucommander.commons.io.bom;
...
@BUG LowPriority - uzff (1 of 3) ->|    private byte[] sig;
@BUG LowPriority - uzff (1 of 3) ->|
@BUG LowPriority - uzff (1 of 3) ->|    /** the character encoding denoted by this BOM */
