 ...
 */
@BUG MediumPriority - modx (2 of 2) ->|
@BUG MediumPriority - modx (2 of 2) ->|package com.mucommander.commons.conf;
 ...
 */
@BUG LowPriority - zwii (1 of 3) ->|public class ValueList extends ArrayList<String> {
@BUG LowPriority - zwii (1 of 3) ->|    // - Initialisation ------------------------------------------------------------------------------------------------
@BUG LowPriority - zwii (1 of 3) ->|    // -----------------------------------------------------------------------------------------------------------------
    /**
