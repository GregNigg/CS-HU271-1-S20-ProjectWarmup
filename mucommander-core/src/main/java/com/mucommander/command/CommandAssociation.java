 ...
 */
@BUG MediumPriority - yabr (2 of 2) ->|
@BUG MediumPriority - yabr (2 of 2) ->|package com.mucommander.command;
...
@BUG LowPriority - xfwc (1 of 3) ->|        this.command    = command;
@BUG LowPriority - xfwc (1 of 3) ->|        this.fileFilter = filter;
@BUG LowPriority - xfwc (1 of 3) ->|    }
