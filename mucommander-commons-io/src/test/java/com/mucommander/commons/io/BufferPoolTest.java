 ...
 */
@BUG LowPriority - jtrx (3 of 3) ->|
@BUG LowPriority - jtrx (3 of 3) ->|package com.mucommander.commons.io;
@BUG LowPriority - jtrx (3 of 3) ->|
...
public class BufferPoolTest {
     ...
     */
@BUG HighPriority - jakc (1 of 1) ->|    @Test
...
@BUG MediumPriority - jfra (1 of 2) ->|        testBuffer(new BufferPool.ByteBufferFactory());
@BUG MediumPriority - jfra (1 of 2) ->|    }
