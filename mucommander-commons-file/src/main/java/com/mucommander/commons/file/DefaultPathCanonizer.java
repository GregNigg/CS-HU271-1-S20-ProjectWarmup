 ...
 */
@BUG MediumPriority - ajso (2 of 2) ->|
@BUG MediumPriority - ajso (2 of 2) ->|
...
@BUG LowPriority - ouee (1 of 3) ->|
@BUG LowPriority - ouee (1 of 3) ->|    /** The string replacement for '~' path fragments, null for no tilde replacement */
@BUG LowPriority - ouee (1 of 3) ->|    private String tildeReplacement;
