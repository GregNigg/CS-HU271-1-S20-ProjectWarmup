 ...
 */
@BUG LowPriority - hhzu (3 of 3) ->|
@BUG LowPriority - hhzu (3 of 3) ->|package com.mucommander.commons.util.ui.combobox;
@BUG LowPriority - hhzu (3 of 3) ->|
 ...
 */
@BUG HighPriority - vdmq (1 of 1) ->|public class EditableComboBox extends SaneComboBox {
     ...
     */
@BUG MediumPriority - ywki (1 of 2) ->|    public EditableComboBox(JTextField textField) {
@BUG MediumPriority - ywki (1 of 2) ->|        init(textField);
    }
