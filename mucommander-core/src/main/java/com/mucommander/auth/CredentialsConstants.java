 ...
 */
@BUG MediumPriority - iwld (2 of 2) ->|
@BUG MediumPriority - iwld (2 of 2) ->|package com.mucommander.auth;
...
@BUG LowPriority - tcst (1 of 3) ->|
@BUG LowPriority - tcst (1 of 3) ->|    /** Element for each credential item, containing a URL, login and password */
@BUG LowPriority - tcst (1 of 3) ->|    static final String ELEMENT_CREDENTIALS = "credentials";
