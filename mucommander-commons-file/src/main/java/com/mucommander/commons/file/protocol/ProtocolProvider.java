 ...
 */
@BUG LowPriority - hqlv (3 of 3) ->|
@BUG LowPriority - hqlv (3 of 3) ->|
@BUG LowPriority - hqlv (3 of 3) ->|package com.mucommander.commons.file.protocol;
 ...
 * @see AbstractFile
 */
@BUG HighPriority - ttcb (1 of 1) ->|public interface ProtocolProvider {
    /**
