 ...
 */
@BUG LowPriority - pyqk (3 of 3) ->|
@BUG LowPriority - pyqk (3 of 3) ->|package com.mucommander.commons.runtime;
@BUG LowPriority - pyqk (3 of 3) ->|
...
public class JavaVersionTest {
     ...
     */
@BUG HighPriority - fwli (1 of 1) ->|    @Test
...
@BUG MediumPriority - hhyx (1 of 2) ->|    }
@BUG MediumPriority - hhyx (1 of 2) ->|
    /**
