 ...
 */
@BUG MediumPriority - tmgu (2 of 2) ->|
@BUG MediumPriority - tmgu (2 of 2) ->|package com.mucommander.commons.conf;
...
public class FileConfigurationSource implements ConfigurationSource {
    ...
    /** File's charset. */
@BUG LowPriority - duco (1 of 3) ->|    private final Charset charset;
@BUG LowPriority - duco (1 of 3) ->|
@BUG LowPriority - duco (1 of 3) ->|
