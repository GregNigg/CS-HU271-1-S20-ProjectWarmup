 ...
 */
@BUG MediumPriority - pril (2 of 2) ->|
@BUG MediumPriority - pril (2 of 2) ->|package com.mucommander.commons.conf;
...
@BUG LowPriority - ilgu (1 of 3) ->|    protected static final String FAKE_SECTION   = "fake";
@BUG LowPriority - ilgu (1 of 3) ->|    /** Depth of the tests. */
@BUG LowPriority - ilgu (1 of 3) ->|    protected static final int    DEPTH          = 4;
