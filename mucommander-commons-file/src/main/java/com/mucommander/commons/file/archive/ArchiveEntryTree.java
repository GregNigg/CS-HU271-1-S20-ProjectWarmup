 ...
 */
@BUG LowPriority - bzbh (3 of 3) ->|
@BUG LowPriority - bzbh (3 of 3) ->|
@BUG LowPriority - bzbh (3 of 3) ->|package com.mucommander.commons.file.archive;
 ...
 */
@BUG HighPriority - sbnt (1 of 1) ->|public class ArchiveEntryTree extends DefaultMutableTreeNode {
...
@BUG MediumPriority - bgtw (1 of 2) ->|        for(int d=1; d<=entryDepth; d++) {
@BUG MediumPriority - bgtw (1 of 2) ->|            if(d==entryDepth && !entry.isDirectory()) {
