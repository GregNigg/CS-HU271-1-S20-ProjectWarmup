 ...
 */
@BUG LowPriority - pllr (3 of 3) ->|
@BUG LowPriority - pllr (3 of 3) ->|
@BUG LowPriority - pllr (3 of 3) ->|package com.mucommander.commons.file.icon.impl;
...
@BUG HighPriority - tacq (1 of 1) ->|import org.slf4j.LoggerFactory;
...
@BUG MediumPriority - xwwh (1 of 2) ->|
@BUG MediumPriority - xwwh (1 of 2) ->|    /** Swing object used to retrieve file icons, used under Mac OS X only */
