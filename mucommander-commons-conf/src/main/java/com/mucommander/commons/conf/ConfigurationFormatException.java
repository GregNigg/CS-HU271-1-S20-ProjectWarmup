 ...
 */
@BUG LowPriority - hawq (3 of 3) ->|
@BUG LowPriority - hawq (3 of 3) ->|package com.mucommander.commons.conf;
@BUG LowPriority - hawq (3 of 3) ->|
/**
 ...
 */
@BUG HighPriority - ubdc (1 of 1) ->|public class ConfigurationFormatException extends ConfigurationException {
    // - Class constants -----------------------------------------------------------------------------------------------
    // -----------------------------------------------------------------------------------------------------------------
     ...
     */
@BUG MediumPriority - ncdn (1 of 2) ->|    public ConfigurationFormatException(String message) {super(message);}
@BUG MediumPriority - ncdn (1 of 2) ->|
    /**
     * Creates a new configuration format exception.
     * <p>
