 ...
 */
@BUG MediumPriority - wxwm (2 of 2) ->|
@BUG MediumPriority - wxwm (2 of 2) ->|package com.mucommander.commons.conf;
...
public class ConfigurationException extends Exception {
     ...
     */
@BUG LowPriority - hawq (1 of 3) ->|    public ConfigurationException(Throwable cause) {super(cause);}
@BUG LowPriority - hawq (1 of 3) ->|
@BUG LowPriority - hawq (1 of 3) ->|    /**
