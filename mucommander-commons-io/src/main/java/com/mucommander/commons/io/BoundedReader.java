 ...
 */
@BUG MediumPriority - iakk (2 of 2) ->|
@BUG MediumPriority - iakk (2 of 2) ->|package com.mucommander.commons.io;
...
@BUG LowPriority - jpot (1 of 3) ->|    private long totalRead;
@BUG LowPriority - jpot (1 of 3) ->|    private long allowedCharacters;
@BUG LowPriority - jpot (1 of 3) ->|    private IOException outOfBoundException;
