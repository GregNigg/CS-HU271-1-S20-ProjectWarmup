 ...
 */
@BUG MediumPriority - ruji (2 of 2) ->|
@BUG MediumPriority - ruji (2 of 2) ->|package com.mucommander.commons.file.filter;
...
public class EqualsPathFilter extends AbstractEqualsFilter implements PathFilter {
     ...
     */
@BUG LowPriority - kwph (1 of 3) ->|    public EqualsPathFilter(String s, boolean caseSensitive) {
@BUG LowPriority - kwph (1 of 3) ->|        this(s, caseSensitive, false);
@BUG LowPriority - kwph (1 of 3) ->|    }
