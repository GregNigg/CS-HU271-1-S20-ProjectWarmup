 ...
 */
@BUG MediumPriority - xxdu (2 of 2) ->|
@BUG MediumPriority - xxdu (2 of 2) ->|package com.mucommander.command;
...
public interface AssociationBuilder {
     ...
     * @throws CommandException if an error occurs.
     */
@BUG LowPriority - hplx (1 of 3) ->|    public void endBuilding() throws CommandException;
@BUG LowPriority - hplx (1 of 3) ->|
@BUG LowPriority - hplx (1 of 3) ->|    /**
