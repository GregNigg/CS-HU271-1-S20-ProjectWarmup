 ...
 */
@BUG LowPriority - syln (3 of 3) ->|
@BUG LowPriority - syln (3 of 3) ->|package com.mucommander;
@BUG LowPriority - syln (3 of 3) ->|
...
@BUG HighPriority - vxvv (1 of 1) ->|    public static final String LICENSE         = "/license.txt";
    ...
    /** Documentation URL. */
@BUG MediumPriority - wloc (1 of 2) ->|    public static final String DOCUMENTATION_URL  = HOMEPAGE_URL + "/documentation/";
@BUG MediumPriority - wloc (1 of 2) ->|
