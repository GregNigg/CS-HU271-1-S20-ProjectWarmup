 ...
 *
 */
@BUG MediumPriority - bzos (2 of 2) ->|
@BUG MediumPriority - bzos (2 of 2) ->|/*
...
public interface BZip2Constants {
    ...
    int RUNA = 0;
    int RUNB = 1;
@BUG LowPriority - vani (1 of 3) ->|    int N_GROUPS = 6;
@BUG LowPriority - vani (1 of 3) ->|    int G_SIZE = 50;
@BUG LowPriority - vani (1 of 3) ->|    int N_ITERS = 4;
