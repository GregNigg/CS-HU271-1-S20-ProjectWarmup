 ...
 */
@BUG LowPriority - jpot (3 of 3) ->|
@BUG LowPriority - jpot (3 of 3) ->|package com.mucommander.commons.io;
@BUG LowPriority - jpot (3 of 3) ->|
 ...
 */
@BUG HighPriority - thnx (1 of 1) ->|public class BufferPool {
...
@BUG MediumPriority - ytti (1 of 2) ->|    public static int defaultBufferSize = INITIAL_DEFAULT_BUFFER_SIZE;
@BUG MediumPriority - ytti (1 of 2) ->|
