 ...
 */
@BUG MediumPriority - rcwd (2 of 2) ->|
@BUG MediumPriority - rcwd (2 of 2) ->|package com.mucommander.commons.conf;
...
@BUG LowPriority - egav (1 of 3) ->|    private   final Attributes     emptyAttributes = new AttributesImpl();
@BUG LowPriority - egav (1 of 3) ->|    /** Root element name. */
@BUG LowPriority - egav (1 of 3) ->|    protected   final String rootElementName;
