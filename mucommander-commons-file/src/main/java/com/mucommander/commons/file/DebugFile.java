 ...
 */
@BUG LowPriority - edrc (3 of 3) ->|
@BUG LowPriority - edrc (3 of 3) ->|
@BUG LowPriority - edrc (3 of 3) ->|package com.mucommander.commons.file;
...
@BUG HighPriority - vzzn (1 of 1) ->|        this(file, 0);
    }
...
@BUG MediumPriority - ajso (1 of 2) ->|
@BUG MediumPriority - ajso (1 of 2) ->|    /**
