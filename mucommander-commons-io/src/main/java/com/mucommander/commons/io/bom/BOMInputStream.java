 ...
 */
@BUG LowPriority - uzff (3 of 3) ->|
@BUG LowPriority - uzff (3 of 3) ->|package com.mucommander.commons.io.bom;
@BUG LowPriority - uzff (3 of 3) ->|
 ...
 */
@BUG HighPriority - shgp (1 of 1) ->|public class BOMInputStream extends InputStream implements BOMConstants {
...
@BUG MediumPriority - zpbk (1 of 2) ->|    private int leadingBytesOff;
@BUG MediumPriority - zpbk (1 of 2) ->|
