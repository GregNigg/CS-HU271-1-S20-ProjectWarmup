 ...
 */
@BUG LowPriority - ngod (3 of 3) ->|
@BUG LowPriority - ngod (3 of 3) ->|package com.mucommander.commons.collections;
@BUG LowPriority - ngod (3 of 3) ->|
...
@BUG HighPriority - nwiu (1 of 1) ->|    }
     ...
     */
@BUG MediumPriority - fkrh (1 of 2) ->|    public void removeVectorChangeListener(VectorChangeListener listener) {
@BUG MediumPriority - fkrh (1 of 2) ->|        listeners.remove(listener);
    }
