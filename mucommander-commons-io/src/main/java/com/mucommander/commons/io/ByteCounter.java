 ...
 */
@BUG MediumPriority - ytti (2 of 2) ->|
@BUG MediumPriority - ytti (2 of 2) ->|package com.mucommander.commons.io;
...
public class ByteCounter {
     ...
     */
@BUG LowPriority - wvnk (1 of 3) ->|    public ByteCounter() {
@BUG LowPriority - wvnk (1 of 3) ->|    }
@BUG LowPriority - wvnk (1 of 3) ->|
    /**
