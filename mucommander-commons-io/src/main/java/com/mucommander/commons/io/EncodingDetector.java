 ...
 */
@BUG LowPriority - oaok (3 of 3) ->|
@BUG LowPriority - oaok (3 of 3) ->|package com.mucommander.commons.io;
@BUG LowPriority - oaok (3 of 3) ->|
 ...
 */
@BUG HighPriority - eaoe (1 of 1) ->|public class EncodingDetector {
...
@BUG MediumPriority - vhxz (1 of 2) ->|    }
@BUG MediumPriority - vhxz (1 of 2) ->|
    /**
