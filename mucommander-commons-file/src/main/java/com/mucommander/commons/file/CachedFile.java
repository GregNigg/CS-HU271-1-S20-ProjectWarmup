 ...
 */
@BUG MediumPriority - zemp (2 of 2) ->|
@BUG MediumPriority - zemp (2 of 2) ->|
 ...
 */
@BUG LowPriority - edrc (1 of 3) ->|public class CachedFile extends ProxyFile {
@BUG LowPriority - edrc (1 of 3) ->|    private static final Logger LOGGER = LoggerFactory.getLogger(CachedFile.class);
@BUG LowPriority - edrc (1 of 3) ->|
