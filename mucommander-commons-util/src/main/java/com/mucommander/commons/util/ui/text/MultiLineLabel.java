 ...
 */
@BUG MediumPriority - uymo (2 of 2) ->|
@BUG MediumPriority - uymo (2 of 2) ->|package com.mucommander.commons.util.ui.text;
...
@BUG LowPriority - hmfs (1 of 3) ->|        this(text, true);
@BUG LowPriority - hmfs (1 of 3) ->|    }
@BUG LowPriority - hmfs (1 of 3) ->|
    /**
