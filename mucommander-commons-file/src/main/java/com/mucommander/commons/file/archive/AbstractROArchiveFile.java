 ...
 */
@BUG LowPriority - uvly (3 of 3) ->|
@BUG LowPriority - uvly (3 of 3) ->|
@BUG LowPriority - uvly (3 of 3) ->|package com.mucommander.commons.file.archive;
...
public abstract class AbstractROArchiveFile extends AbstractArchiveFile {
     ...
     */
@BUG HighPriority - fcii (1 of 1) ->|    protected AbstractROArchiveFile(AbstractFile file) {
        super(file);
    }
