 ...
 */
@BUG MediumPriority - iwdf (2 of 2) ->|
@BUG MediumPriority - iwdf (2 of 2) ->|package com.mucommander.auth;
...
@BUG LowPriority - xywt (1 of 3) ->|    private FileURL url;
@BUG LowPriority - xywt (1 of 3) ->|    private Map<String, String> urlProperties;
@BUG LowPriority - xywt (1 of 3) ->|    private String login;
