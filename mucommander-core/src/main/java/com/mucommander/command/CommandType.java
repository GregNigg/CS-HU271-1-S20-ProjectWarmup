 ...
 */
@BUG LowPriority - kkkr (3 of 3) ->|
@BUG LowPriority - kkkr (3 of 3) ->|package com.mucommander.command;
@BUG LowPriority - kkkr (3 of 3) ->|
...
@BUG HighPriority - vpox (1 of 1) ->|    INVISIBLE_COMMAND(CommandsXmlConstants.VALUE_INVISIBLE);
     ...
     */
@BUG MediumPriority - xxbq (1 of 2) ->|    public static CommandType parseCommandType(String value) {
@BUG MediumPriority - xxbq (1 of 2) ->|    	if (value == null)
