 ...
 */
@BUG LowPriority - yzjo (3 of 3) ->|
@BUG LowPriority - yzjo (3 of 3) ->|package com.mucommander.commons.file.filter;
@BUG LowPriority - yzjo (3 of 3) ->|
...
public abstract class AbstractFilenameFilter extends AbstractStringCriterionFilter implements FilenameFilter {
     ...
     */
@BUG HighPriority - cuvs (1 of 1) ->|    public AbstractFilenameFilter(boolean caseSensitive) {
