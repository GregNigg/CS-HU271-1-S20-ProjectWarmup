 ...
 */
@BUG MediumPriority - vlru (2 of 2) ->|
@BUG MediumPriority - vlru (2 of 2) ->|
...
public interface CacheableFileIconProvider extends FileIconProvider {
     ...
     */
@BUG LowPriority - enfa (1 of 3) ->|    boolean isCacheable(AbstractFile file, Dimension preferredResolution);
@BUG LowPriority - enfa (1 of 3) ->|
@BUG LowPriority - enfa (1 of 3) ->|    /**
