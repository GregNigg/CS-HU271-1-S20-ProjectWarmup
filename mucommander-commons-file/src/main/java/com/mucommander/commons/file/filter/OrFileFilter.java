 ...
 */
@BUG MediumPriority - fhlj (2 of 2) ->|
@BUG MediumPriority - fhlj (2 of 2) ->|package com.mucommander.commons.file.filter;
...
public class OrFileFilter extends ChainedFileFilter {
     ...
     */
@BUG LowPriority - jczu (1 of 3) ->|    public OrFileFilter(FileFilter... filters) {
@BUG LowPriority - jczu (1 of 3) ->|        this(false, filters);
@BUG LowPriority - jczu (1 of 3) ->|    }
