 ...
 */
@BUG MediumPriority - kvyb (2 of 2) ->|
@BUG MediumPriority - kvyb (2 of 2) ->|
...
public class GroupedPermissionBits implements PermissionBits {
     ...
     */
@BUG LowPriority - efyg (1 of 3) ->|    public GroupedPermissionBits(int permissions) {
@BUG LowPriority - efyg (1 of 3) ->|        this.permissions = permissions;
@BUG LowPriority - efyg (1 of 3) ->|    }
