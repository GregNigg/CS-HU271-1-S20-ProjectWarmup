 ...
 */
@BUG MediumPriority - fxmr (2 of 2) ->|
@BUG MediumPriority - fxmr (2 of 2) ->|package com.mucommander.commons.file.archive;
...
@BUG LowPriority - lksj (1 of 3) ->|    protected ArchiveEntry entry;
@BUG LowPriority - lksj (1 of 3) ->|
@BUG LowPriority - lksj (1 of 3) ->|    public SingleArchiveEntryIterator(ArchiveEntry entry) {
        this.entry = entry;
    }
