 ...
 */
@BUG LowPriority - hmfs (3 of 3) ->|
@BUG LowPriority - hmfs (3 of 3) ->|package com.mucommander.commons.util;
@BUG LowPriority - hmfs (3 of 3) ->|
...
@BUG HighPriority - atoo (1 of 1) ->|    public Iterator<Object[]> endsWithTestCases() {
      List<Object[]> data;
...
@BUG MediumPriority - skpa (1 of 2) ->|        return data.iterator();
@BUG MediumPriority - skpa (1 of 2) ->|    }
