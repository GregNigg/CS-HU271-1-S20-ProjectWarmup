 ...
 */
@BUG LowPriority - klbd (3 of 3) ->|
@BUG LowPriority - klbd (3 of 3) ->|
@BUG LowPriority - klbd (3 of 3) ->|package com.mucommander.commons.file.util;
...
public class OSXFileUtils {
     ...
     */
@BUG HighPriority - mvts (1 of 1) ->|    public static String getSpotlightComment(AbstractFile file) {
...
@BUG MediumPriority - rvis (1 of 2) ->|            ByteArrayOutputStream bout = new ByteArrayOutputStream();
@BUG MediumPriority - rvis (1 of 2) ->|            pin = process.getInputStream();
