 ...
 */
@BUG MediumPriority - ivnf (2 of 2) ->|
@BUG MediumPriority - ivnf (2 of 2) ->|package com.mucommander.commons.io;
 ...
 */
@BUG LowPriority - oaok (1 of 3) ->|public class CounterInputStream extends InputStream {
@BUG LowPriority - oaok (1 of 3) ->|
@BUG LowPriority - oaok (1 of 3) ->|    /** Underlying InputStream */
