 ...
 */
@BUG LowPriority - bbei (3 of 3) ->|
@BUG LowPriority - bbei (3 of 3) ->|
@BUG LowPriority - bbei (3 of 3) ->|package com.mucommander.commons.file.util;
 ...
 */
@BUG HighPriority - wcse (1 of 1) ->|public class FileMonitor implements FileMonitorConstants, Runnable {
...
@BUG MediumPriority - rhvf (1 of 2) ->|    private WeakHashMap<FileChangeListener, ?> listeners = new WeakHashMap<FileChangeListener, Object>();
@BUG MediumPriority - rhvf (1 of 2) ->|
