 ...
 */
@BUG MediumPriority - dqnu (2 of 2) ->|
@BUG MediumPriority - dqnu (2 of 2) ->|package com.mucommander.commons.io;
...
@BUG LowPriority - sptf (1 of 3) ->|
@BUG LowPriority - sptf (1 of 3) ->|    /** The underlying OutputStream to filter */
@BUG LowPriority - sptf (1 of 3) ->|    protected OutputStream out;
