 ...
 */
@BUG MediumPriority - bzvr (2 of 2) ->|
@BUG MediumPriority - bzvr (2 of 2) ->|package com.mucommander.commons.util.ui.border;
...
public class MutableLineBorder extends LineBorder {
     ...
     */
@BUG LowPriority - hxzm (1 of 3) ->|    public MutableLineBorder(Color color, int thickness) {super(color, thickness);}
@BUG LowPriority - hxzm (1 of 3) ->|
@BUG LowPriority - hxzm (1 of 3) ->|    /**
