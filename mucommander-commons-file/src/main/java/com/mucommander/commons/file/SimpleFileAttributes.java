 ...
 */
@BUG LowPriority - flvb (3 of 3) ->|
@BUG LowPriority - flvb (3 of 3) ->|
@BUG LowPriority - flvb (3 of 3) ->|package com.mucommander.commons.file;
...
public class SimpleFileAttributes implements MutableFileAttributes {
    ...
    /** Directory attribute */
@BUG HighPriority - foez (1 of 1) ->|    private boolean directory;
     ...
     */
@BUG MediumPriority - jyvw (1 of 2) ->|    public SimpleFileAttributes(AbstractFile file) {
@BUG MediumPriority - jyvw (1 of 2) ->|        setPath(file.getAbsolutePath());
