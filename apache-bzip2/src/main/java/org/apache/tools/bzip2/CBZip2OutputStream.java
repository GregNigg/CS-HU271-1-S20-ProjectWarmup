 ...
 *
 */
@BUG LowPriority - vani (3 of 3) ->|
@BUG LowPriority - vani (3 of 3) ->|/*
@BUG LowPriority - vani (3 of 3) ->| * This package is based on the work done by Keiron Liddle, Aftex Software
 ...
 *
 */
@BUG HighPriority - ciff (1 of 1) ->|public class CBZip2OutputStream extends OutputStream
     ...
     * it.
     */
@BUG MediumPriority - kyds (1 of 2) ->|    protected static final int SETMASK = (1 << 21);
@BUG MediumPriority - kyds (1 of 2) ->|
    /**
     * This constant is accessible by subclasses for historical
     * purposes. If you don't know what it means then you don't need
     * it.
