 ...
 */
@BUG MediumPriority - pmrs (2 of 2) ->|
@BUG MediumPriority - pmrs (2 of 2) ->|package com.mucommander.core;
 ...
 * @author Arik Hadas
 */
@BUG LowPriority - notw (1 of 3) ->|public class GlobalLocationHistory extends LocationAdapter {
@BUG LowPriority - notw (1 of 3) ->|	private static final Logger LOGGER = LoggerFactory.getLogger(GlobalLocationHistory.class);
@BUG LowPriority - notw (1 of 3) ->|	
	/** Singleton instance */
