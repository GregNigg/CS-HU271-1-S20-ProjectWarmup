 ...
 */
@BUG MediumPriority - jxxc (2 of 2) ->|
@BUG MediumPriority - jxxc (2 of 2) ->|package com.mucommander.commons.io;
 ...
 */
@BUG LowPriority - oqep (1 of 3) ->|public class SilenceableOutputStream extends FilterOutputStream {
@BUG LowPriority - oqep (1 of 3) ->|
@BUG LowPriority - oqep (1 of 3) ->|    /** When true, write methods are no-op */
