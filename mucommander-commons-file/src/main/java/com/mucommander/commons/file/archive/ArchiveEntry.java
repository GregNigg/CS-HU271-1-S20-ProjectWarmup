 ...
 */
@BUG MediumPriority - skpv (2 of 2) ->|
@BUG MediumPriority - skpv (2 of 2) ->|
 ...
 */
@BUG LowPriority - bzbh (1 of 3) ->|public class ArchiveEntry extends SimpleFileAttributes {
@BUG LowPriority - bzbh (1 of 3) ->|
@BUG LowPriority - bzbh (1 of 3) ->|    /** Encapsulated entry object */
