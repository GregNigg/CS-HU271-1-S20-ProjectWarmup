 ...
 */
@BUG LowPriority - xemh (3 of 3) ->|
@BUG LowPriority - xemh (3 of 3) ->|package com.mucommander.commons.io.compound;
@BUG LowPriority - xemh (3 of 3) ->|
...
public class CompoundInputStreamTest {
    ...
    private final static String[] TEST_STRINGS = {
        "",
        "this",
@BUG HighPriority - xaos (1 of 1) ->|        "is",
        "a",
        "",
        "test",
        ""
...
@BUG MediumPriority - bfgq (1 of 2) ->|            sb.append(testString);
@BUG MediumPriority - bfgq (1 of 2) ->|
