 ...
 */
@BUG LowPriority - lksj (3 of 3) ->|
@BUG LowPriority - lksj (3 of 3) ->|package com.mucommander.commons.file.compat;
@BUG LowPriority - lksj (3 of 3) ->|
...
@BUG HighPriority - ygzy (1 of 1) ->|    }
    ...
    private void checkConnected() throws IOException {
        if(!connected)
@BUG MediumPriority - bqdh (1 of 2) ->|            connect();
@BUG MediumPriority - bqdh (1 of 2) ->|    }
