 ...
 */
@BUG LowPriority - byje (3 of 3) ->|
@BUG LowPriority - byje (3 of 3) ->|package com.mucommander.commons.conf;
@BUG LowPriority - byje (3 of 3) ->|
...
@BUG HighPriority - comi (1 of 1) ->|    }
     ...
     */
@BUG MediumPriority - njod (1 of 2) ->|    @Override
@BUG MediumPriority - njod (1 of 2) ->|    public boolean moveTo(String name, boolean create) {
