@BUG MediumPriority - fiud (2 of 2) ->|package com.mucommander.core;
@BUG MediumPriority - fiud (2 of 2) ->|
...
@BUG LowPriority - vxao (1 of 3) ->|import com.mucommander.commons.file.UnsupportedFileOperationException;
@BUG LowPriority - vxao (1 of 3) ->|import com.mucommander.commons.io.RandomAccessInputStream;
@BUG LowPriority - vxao (1 of 3) ->|import com.mucommander.commons.io.RandomAccessOutputStream;
