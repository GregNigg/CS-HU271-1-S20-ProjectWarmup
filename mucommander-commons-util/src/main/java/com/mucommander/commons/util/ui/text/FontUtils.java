 ...
 */
@BUG LowPriority - yqve (3 of 3) ->|
@BUG LowPriority - yqve (3 of 3) ->|package com.mucommander.commons.util.ui.text;
@BUG LowPriority - yqve (3 of 3) ->|
...
public class FontUtils {
     ...
     */
@BUG HighPriority - yjoc (1 of 1) ->|    public static JComponent changeStyle(JComponent comp, int newStyle) {
     ...
     * @return the component that was passed, for convenience only
     */
@BUG MediumPriority - uymo (1 of 2) ->|    public static JComponent changeStyleAndSize(JComponent comp, int newStyle, float newSize) {
@BUG MediumPriority - uymo (1 of 2) ->|        comp.setFont(comp.getFont().deriveFont(newStyle, newSize));
        return comp;
    }
