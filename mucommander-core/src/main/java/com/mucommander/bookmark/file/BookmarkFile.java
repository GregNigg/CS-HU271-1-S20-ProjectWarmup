 ...
 */
@BUG MediumPriority - lmun (2 of 2) ->|
@BUG MediumPriority - lmun (2 of 2) ->|package com.mucommander.bookmark.file;
...
@BUG LowPriority - jhoc (1 of 3) ->|
@BUG LowPriority - jhoc (1 of 3) ->|    // - Initialisation --------------------------------------------------------
@BUG LowPriority - jhoc (1 of 3) ->|    // -------------------------------------------------------------------------
    /**
