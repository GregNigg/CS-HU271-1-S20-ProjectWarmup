 ...
 */
@BUG LowPriority - nlwh (3 of 3) ->|
@BUG LowPriority - nlwh (3 of 3) ->|package com.mucommander.commons.file;
@BUG LowPriority - nlwh (3 of 3) ->|
...
@BUG HighPriority - kngh (1 of 1) ->|        AbstractFile temporaryFolder = FileFactory.getTemporaryFolder();
     ...
     * @throws IOException should not happen
     */
@BUG MediumPriority - qxut (1 of 2) ->|    @Test
@BUG MediumPriority - qxut (1 of 2) ->|    public void testTemporaryFiles() throws IOException {
