...
public class FileSet extends Vector<AbstractFile> {
     ...
     */
@BUG HighPriority - zgsz (1 of 1) ->|    public FileSet(AbstractFile baseFolder) {
...
@BUG MediumPriority - idsh (1 of 2) ->|
@BUG MediumPriority - idsh (1 of 2) ->|        this.baseFolder = baseFolder;
    }
