 ...
 */
@BUG LowPriority - ouee (3 of 3) ->|
@BUG LowPriority - ouee (3 of 3) ->|
@BUG LowPriority - ouee (3 of 3) ->|package com.mucommander.commons.file;
 ...
 */
@BUG HighPriority - sxhw (1 of 1) ->|public class DefaultSchemeParser implements SchemeParser {
     ...
     */
@BUG MediumPriority - frhp (1 of 2) ->|    public DefaultSchemeParser(boolean parseQuery) {
@BUG MediumPriority - frhp (1 of 2) ->|        this(new DefaultPathCanonizer(System.getProperty("file.separator"), null), parseQuery);
    }
