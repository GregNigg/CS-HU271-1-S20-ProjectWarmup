 ...
 */
@BUG LowPriority - tmup (3 of 3) ->|
@BUG LowPriority - tmup (3 of 3) ->|package com.mucommander.commons.conf;
@BUG LowPriority - tmup (3 of 3) ->|
...
@BUG HighPriority - fadg (1 of 1) ->|        variables = new HashMap<String, String>();
...
@BUG MediumPriority - yqyi (1 of 2) ->|
@BUG MediumPriority - yqyi (1 of 2) ->|    /**
