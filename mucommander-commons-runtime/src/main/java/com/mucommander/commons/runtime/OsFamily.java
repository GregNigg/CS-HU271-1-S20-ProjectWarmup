 ...
 */
@BUG MediumPriority - ksus (2 of 2) ->|
@BUG MediumPriority - ksus (2 of 2) ->|package com.mucommander.commons.runtime;
...
public enum OsFamily {
    ...
    OPENVMS("OpenVMS"),
    /** Other OS */
@BUG LowPriority - pyqk (1 of 3) ->|    UNKNOWN_OS_FAMILY("Unknown");
@BUG LowPriority - pyqk (1 of 3) ->|
@BUG LowPriority - pyqk (1 of 3) ->|    /** Logger used by this class. */
