 ...
 */
@BUG LowPriority - kwph (3 of 3) ->|
@BUG LowPriority - kwph (3 of 3) ->|package com.mucommander.commons.file.filter;
@BUG LowPriority - kwph (3 of 3) ->|
/**
...
public class ExtensionPathFilter extends AbstractExtensionFilter implements PathFilter {
     ...
     */
@BUG HighPriority - onnz (1 of 1) ->|    public ExtensionPathFilter(String extension, boolean caseSensitive, boolean inverted) {
     ...
     * @param inverted if true, this filter will operate in inverted mode.
     */
@BUG MediumPriority - xgqh (1 of 2) ->|    public ExtensionPathFilter(String[] ext, boolean caseSensitive, boolean inverted) {
@BUG MediumPriority - xgqh (1 of 2) ->|        super(new PathGenerator(), ext, caseSensitive, inverted);
    }
}
