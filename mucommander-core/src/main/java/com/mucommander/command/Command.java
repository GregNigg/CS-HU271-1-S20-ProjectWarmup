 ...
 */
@BUG LowPriority - zaeq (3 of 3) ->|
@BUG LowPriority - zaeq (3 of 3) ->|package com.mucommander.command;
@BUG LowPriority - zaeq (3 of 3) ->|
 ...
 *   <li>
 *     A {@link #getType() type}, which can be any of {@link #SYSTEM_COMMAND system} (invisible and immutable),
 ...
 */
@BUG HighPriority - qmzu (1 of 1) ->|public class Command implements Comparable<Command> {
    // - Keywords ------------------------------------------------------------------------------------------------------
    // -----------------------------------------------------------------------------------------------------------------
    ...
    /** Original command. */
@BUG MediumPriority - yabr (1 of 2) ->|    private final String      command;
@BUG MediumPriority - yabr (1 of 2) ->|    /** Name used to display the command to users. */
