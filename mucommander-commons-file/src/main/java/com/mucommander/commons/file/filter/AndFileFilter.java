 ...
 */
@BUG MediumPriority - bzlg (2 of 2) ->|
@BUG MediumPriority - bzlg (2 of 2) ->|package com.mucommander.commons.file.filter;
...
public class AndFileFilter extends ChainedFileFilter {
     ...
     */
@BUG LowPriority - jrir (1 of 3) ->|    public AndFileFilter(FileFilter... filters) {
@BUG LowPriority - jrir (1 of 3) ->|        this(false, filters);
@BUG LowPriority - jrir (1 of 3) ->|    }
