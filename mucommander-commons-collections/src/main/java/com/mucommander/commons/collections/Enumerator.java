 ...
 */
@BUG MediumPriority - fkrh (2 of 2) ->|
@BUG MediumPriority - fkrh (2 of 2) ->|package com.mucommander.commons.collections;
...
public class Enumerator<T> implements Iterator<T> {
     ...
     */
@BUG LowPriority - byje (1 of 3) ->|    public Enumerator(Enumeration<T> e) {enumeration = e;}
@BUG LowPriority - byje (1 of 3) ->|
@BUG LowPriority - byje (1 of 3) ->|
