 ...
 */
@BUG MediumPriority - jhqj (2 of 2) ->|
@BUG MediumPriority - jhqj (2 of 2) ->|package com.mucommander.commons.file.archiver;
...
@BUG LowPriority - ngod (1 of 3) ->|    private TarOutputStream tos;
@BUG LowPriority - ngod (1 of 3) ->|    private boolean firstEntry = true;
@BUG LowPriority - ngod (1 of 3) ->|
