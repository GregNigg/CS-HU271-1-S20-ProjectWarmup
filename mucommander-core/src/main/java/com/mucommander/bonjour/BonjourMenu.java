 ...
 */
@BUG MediumPriority - zfak (2 of 2) ->|
@BUG MediumPriority - zfak (2 of 2) ->|package com.mucommander.bonjour;
...
public abstract class BonjourMenu extends JMenu implements MenuListener {
     ...
     */
@BUG LowPriority - skww (1 of 3) ->|    public BonjourMenu() {
@BUG LowPriority - skww (1 of 3) ->|        super(Translator.get("bonjour.bonjour_services"));
@BUG LowPriority - skww (1 of 3) ->|
