 ...
 */
@BUG MediumPriority - kqid (2 of 2) ->|
@BUG MediumPriority - kqid (2 of 2) ->|package com.mucommander.commons.io.base64;
...
@BUG LowPriority - urmk (1 of 3) ->|    private int readBuffer[] = new int[3];
@BUG LowPriority - urmk (1 of 3) ->|
@BUG LowPriority - urmk (1 of 3) ->|    /** Index of the next byte available for reading in the buffer */
