 ...
 */
@BUG MediumPriority - jyvw (2 of 2) ->|
@BUG MediumPriority - jyvw (2 of 2) ->|
...
public class SimpleFilePermissions extends GroupedPermissionBits implements FilePermissions {
     ...
     */
@BUG LowPriority - cods (1 of 3) ->|    public SimpleFilePermissions(int permissions) {
@BUG LowPriority - cods (1 of 3) ->|        this(permissions, FULL_PERMISSION_BITS);
@BUG LowPriority - cods (1 of 3) ->|    }
