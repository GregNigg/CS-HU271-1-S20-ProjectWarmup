 ...
 */
@BUG LowPriority - bfmu (3 of 3) ->|
@BUG LowPriority - bfmu (3 of 3) ->|package com.mucommander.commons.file.util;
@BUG LowPriority - bfmu (3 of 3) ->|
...
public class FileComparatorTest {
    ...
    AbstractFile[] files;
@BUG HighPriority - twmd (1 of 1) ->|    private TestFile A;
    private TestFile B;
    private TestFile C;
    private TestFile D;
    ...
    protected void setUp() throws Exception {
        ...
        files[1] = D;
        files[2] = A;
@BUG MediumPriority - dxoh (1 of 2) ->|        files[3] = B;
@BUG MediumPriority - dxoh (1 of 2) ->|    }
