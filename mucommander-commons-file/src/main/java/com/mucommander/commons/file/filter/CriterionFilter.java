 ...
 */
@BUG LowPriority - ikpf (3 of 3) ->|
@BUG LowPriority - ikpf (3 of 3) ->|package com.mucommander.commons.file.filter;
@BUG LowPriority - ikpf (3 of 3) ->|
...
public interface CriterionFilter<C> extends FileFilter {
     ...
     */
@BUG HighPriority - ggfi (1 of 1) ->|    boolean match(C value);
     ...
     */
@BUG MediumPriority - xdnq (1 of 2) ->|    boolean match(C value[]);
@BUG MediumPriority - xdnq (1 of 2) ->|
    /**
