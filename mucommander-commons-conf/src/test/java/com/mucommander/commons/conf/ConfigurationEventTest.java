 ...
 */
@BUG LowPriority - egav (3 of 3) ->|
@BUG LowPriority - egav (3 of 3) ->|package com.mucommander.commons.conf;
@BUG LowPriority - egav (3 of 3) ->|
...
public class ConfigurationEventTest {
    ...
    /** Test float value. */
@BUG HighPriority - yays (1 of 1) ->|    private static final float          FLOAT_VALUE   = (float)10.5;
    /** Test double value. */
...
@BUG MediumPriority - pril (1 of 2) ->|
@BUG MediumPriority - pril (1 of 2) ->|
    // - Initialisation ------------------------------------------------------------------------------------------------
    // -----------------------------------------------------------------------------------------------------------------
    static {
