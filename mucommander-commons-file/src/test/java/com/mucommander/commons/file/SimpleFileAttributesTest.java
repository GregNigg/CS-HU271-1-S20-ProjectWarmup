 ...
 */
@BUG MediumPriority - iobe (2 of 2) ->|
@BUG MediumPriority - iobe (2 of 2) ->|package com.mucommander.commons.file;
...
@BUG LowPriority - cawb (1 of 3) ->|
@BUG LowPriority - cawb (1 of 3) ->|    /**
@BUG LowPriority - cawb (1 of 3) ->|     * Creates a SimpleFileAttributes instance from an AbstractFile and ensures that the values returned by
