 ...
 */
@BUG MediumPriority - skpa (2 of 2) ->|package com.mucommander;
@BUG MediumPriority - skpa (2 of 2) ->|
...
@BUG LowPriority - syln (1 of 3) ->|
@BUG LowPriority - syln (1 of 3) ->|/**
@BUG LowPriority - syln (1 of 3) ->| * This is the OSGi bundle-activator of the core component of muCommander.
