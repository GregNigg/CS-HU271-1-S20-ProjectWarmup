 ...
 */
@BUG LowPriority - aush (3 of 3) ->|
@BUG LowPriority - aush (3 of 3) ->|package com.mucommander.commons.io;
@BUG LowPriority - aush (3 of 3) ->|
...
public interface RandomAccess {
     ...
     * @throws IOException if an I/O error occurs.
     */
@BUG HighPriority - xwwa (1 of 1) ->|    long getOffset() throws IOException;
     ...
     * @throws IOException if an I/O error occurs
     */
@BUG MediumPriority - amvj (1 of 2) ->|    void seek(long offset) throws IOException;
@BUG MediumPriority - amvj (1 of 2) ->|
}
