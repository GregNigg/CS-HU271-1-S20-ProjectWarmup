 ...
 */
@BUG LowPriority - skww (3 of 3) ->|
@BUG LowPriority - skww (3 of 3) ->|
@BUG LowPriority - skww (3 of 3) ->|package com.mucommander.bookmark;
...
public class Bookmark implements Cloneable {
     ...
     */
@BUG HighPriority - freb (1 of 1) ->|    public Bookmark(String name, String location) {
...
@BUG MediumPriority - kfmk (1 of 2) ->|            BookmarkManager.fireBookmarksChanged();
@BUG MediumPriority - kfmk (1 of 2) ->|        }
    }
