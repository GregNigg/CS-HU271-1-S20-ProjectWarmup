 ...
 */
@BUG MediumPriority - yqyi (2 of 2) ->|
@BUG MediumPriority - yqyi (2 of 2) ->|package com.mucommander.commons.conf;
...
public interface ConfigurationSource {
     ...
     */
@BUG LowPriority - mlzk (1 of 3) ->|    Reader getReader() throws IOException;
@BUG LowPriority - mlzk (1 of 3) ->|
@BUG LowPriority - mlzk (1 of 3) ->|    /**
