 ...
 */
@BUG LowPriority - mpsj (3 of 3) ->|
@BUG LowPriority - mpsj (3 of 3) ->|package com.mucommander.commons.io;
@BUG LowPriority - mpsj (3 of 3) ->|
...
public class BoundedOutputStream extends FilteredOutputStream implements Bounded {
     ...
     */
@BUG HighPriority - xgpl (1 of 1) ->|    public BoundedOutputStream(OutputStream out, long allowedBytes) {
        super(out);
...
@BUG MediumPriority - iakk (1 of 2) ->|    public synchronized long getRemainingBytes() {
@BUG MediumPriority - iakk (1 of 2) ->|        return allowedBytes<=-1?Long.MAX_VALUE:allowedBytes-totalWritten;
    }
