 ...
 */
@BUG HighPriority - zazg (1 of 1) ->|package com.mucommander.commons.file.osgi;
 ...
 * @author Arik Hadas
 */
@BUG MediumPriority - xsmr (1 of 2) ->|public class FileProtocolServiceTracker extends ServiceTracker<FileProtocolService, FileProtocolService> {
@BUG MediumPriority - xsmr (1 of 2) ->|    private static final Logger LOGGER = LoggerFactory.getLogger(FileProtocolServiceTracker.class);
