 ...
 */
@BUG LowPriority - jrir (3 of 3) ->|
@BUG LowPriority - jrir (3 of 3) ->|package com.mucommander.commons.file.filter;
@BUG LowPriority - jrir (3 of 3) ->|
...
@BUG HighPriority - jbui (1 of 1) ->|    }
    ...
    public ChainedFileFilter(boolean inverted, FileFilter... filters) {
        super(inverted);
@BUG MediumPriority - dghb (1 of 2) ->|
@BUG MediumPriority - dghb (1 of 2) ->|        for(FileFilter filter : filters)
