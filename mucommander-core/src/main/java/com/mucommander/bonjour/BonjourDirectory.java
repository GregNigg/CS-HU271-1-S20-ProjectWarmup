 ...
 */
@BUG LowPriority - xywt (3 of 3) ->|
@BUG LowPriority - xywt (3 of 3) ->|package com.mucommander.bonjour;
@BUG LowPriority - xywt (3 of 3) ->|
 ...
 * @see BonjourMenu
 */
@BUG HighPriority - sjjl (1 of 1) ->|public class BonjourDirectory implements ServiceListener {
...
@BUG MediumPriority - zfak (1 of 2) ->|        {"_smb._tcp.local.", FileProtocols.SMB}
@BUG MediumPriority - zfak (1 of 2) ->|    };
