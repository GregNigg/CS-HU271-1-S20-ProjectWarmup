 ...
 */
@BUG LowPriority - ekbn (3 of 3) ->|
@BUG LowPriority - ekbn (3 of 3) ->|package com.mucommander.bookmark;
@BUG LowPriority - ekbn (3 of 3) ->|
 ...
 */
@BUG HighPriority - nxlk (1 of 1) ->|public class XORCipher {
...
@BUG MediumPriority - lmun (1 of 2) ->|
@BUG MediumPriority - lmun (1 of 2) ->|        byte[] result = new byte[len];
        for(int i=0; i<len; i++)
