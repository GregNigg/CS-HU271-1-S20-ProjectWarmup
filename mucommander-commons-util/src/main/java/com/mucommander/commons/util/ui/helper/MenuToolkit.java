 ...
 */
@BUG LowPriority - bvkk (3 of 3) ->|
@BUG LowPriority - bvkk (3 of 3) ->|
@BUG LowPriority - bvkk (3 of 3) ->|package com.mucommander.commons.util.ui.helper;
 ...
 */
@BUG HighPriority - qhie (1 of 1) ->|public class MenuToolkit {
    ...
    public static JMenu addMenu(String title, MnemonicHelper mnemonicHelper, MenuListener menuListener) {
        ...
        return menu;
@BUG MediumPriority - bath (1 of 2) ->|    }
@BUG MediumPriority - bath (1 of 2) ->|
