 ...
 */
@BUG MediumPriority - qxut (2 of 2) ->|
@BUG MediumPriority - qxut (2 of 2) ->|package com.mucommander.commons.file;
...
public class FileTestTransformer implements IMethodInterceptor {
    ...
    static {
        String      path;
@BUG LowPriority - mesg (1 of 3) ->|        InputStream in;
@BUG LowPriority - mesg (1 of 3) ->|        Properties  properties;
@BUG LowPriority - mesg (1 of 3) ->|
