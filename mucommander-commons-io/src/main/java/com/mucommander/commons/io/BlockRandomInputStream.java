 ...
 */
@BUG LowPriority - fzwx (3 of 3) ->|
@BUG LowPriority - fzwx (3 of 3) ->|package com.mucommander.commons.io;
@BUG LowPriority - fzwx (3 of 3) ->|
 ...
 */
@BUG HighPriority - ohsv (1 of 1) ->|public abstract class BlockRandomInputStream extends RandomAccessInputStream {
     ...
     */
@BUG MediumPriority - xqnw (1 of 2) ->|    protected BlockRandomInputStream(int blockSize) {
@BUG MediumPriority - xqnw (1 of 2) ->|        this.blockSize = blockSize;
