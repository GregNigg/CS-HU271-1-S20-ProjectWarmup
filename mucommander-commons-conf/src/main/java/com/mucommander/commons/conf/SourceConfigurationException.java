 ...
 */
@BUG LowPriority - duco (3 of 3) ->|
@BUG LowPriority - duco (3 of 3) ->|package com.mucommander.commons.conf;
@BUG LowPriority - duco (3 of 3) ->|
/**
...
public class SourceConfigurationException extends ConfigurationException {
     ...
     */
@BUG HighPriority - eadn (1 of 1) ->|    public SourceConfigurationException(String message) {super(message);}
