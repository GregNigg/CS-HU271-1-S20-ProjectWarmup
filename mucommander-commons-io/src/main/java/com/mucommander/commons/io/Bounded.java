 ...
 */
@BUG MediumPriority - xqnw (2 of 2) ->|
@BUG MediumPriority - xqnw (2 of 2) ->|package com.mucommander.commons.io;
...
public interface Bounded {
     ...
     */
@BUG LowPriority - mpsj (1 of 3) ->|    long getProcessedBytes();
@BUG LowPriority - mpsj (1 of 3) ->|
@BUG LowPriority - mpsj (1 of 3) ->|    /**
