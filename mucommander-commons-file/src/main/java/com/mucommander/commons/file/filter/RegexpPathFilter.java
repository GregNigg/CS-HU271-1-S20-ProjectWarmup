 ...
 */
@BUG MediumPriority - mymg (2 of 2) ->|
@BUG MediumPriority - mymg (2 of 2) ->|
...
public class RegexpPathFilter extends AbstractRegexpFilter implements PathFilter {
     ...
     * @throws PatternSyntaxException if the syntax of the regular expression is not correct.
     */
@BUG LowPriority - ugha (1 of 3) ->|    public RegexpPathFilter(String regexp, boolean caseSensitive, boolean inverted) throws PatternSyntaxException {
@BUG LowPriority - ugha (1 of 3) ->|        super(new PathGenerator(), regexp, caseSensitive, inverted);
@BUG LowPriority - ugha (1 of 3) ->|    }
}
