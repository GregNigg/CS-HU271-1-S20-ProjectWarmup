 ...
 */
@BUG LowPriority - wdtg (3 of 3) ->|
@BUG LowPriority - wdtg (3 of 3) ->|package com.mucommander.commons.io.base64;
@BUG LowPriority - wdtg (3 of 3) ->|
...
public abstract class Base64Encoder {
     ...
     */
@BUG HighPriority - fzfd (1 of 1) ->|    public static String encode(byte[] b) {
...
@BUG MediumPriority - kqid (1 of 2) ->|    }
@BUG MediumPriority - kqid (1 of 2) ->|
    /**
