 ...
 */
@BUG MediumPriority - zkbh (2 of 2) ->|
@BUG MediumPriority - zkbh (2 of 2) ->|package com.mucommander.command;
 ...
 */
@BUG LowPriority - kkkr (1 of 3) ->|public class CommandReader extends DefaultHandler implements CommandsXmlConstants {
@BUG LowPriority - kkkr (1 of 3) ->|    // - Instance variables --------------------------------------------------
@BUG LowPriority - kkkr (1 of 3) ->|    // -----------------------------------------------------------------------
