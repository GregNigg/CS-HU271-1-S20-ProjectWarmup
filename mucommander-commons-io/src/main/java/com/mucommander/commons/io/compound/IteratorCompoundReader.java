 ...
 */
@BUG LowPriority - yjjt (3 of 3) ->|
@BUG LowPriority - yjjt (3 of 3) ->|package com.mucommander.commons.io.compound;
@BUG LowPriority - yjjt (3 of 3) ->|
...
@BUG HighPriority - elnw (1 of 1) ->|    private Iterator<? extends Reader> readerIterator;
