 ...
 */
@BUG LowPriority - xfwc (3 of 3) ->|
@BUG LowPriority - xfwc (3 of 3) ->|package com.mucommander.command;
@BUG LowPriority - xfwc (3 of 3) ->|
/**
...
public class CommandException extends Exception {
     ...
     */
@BUG HighPriority - ppnw (1 of 1) ->|    public CommandException(Throwable cause) {super(cause);}
