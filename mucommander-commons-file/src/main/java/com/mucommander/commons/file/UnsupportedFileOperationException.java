...
public class UnsupportedFileOperationException extends IOException {
     ...
     */
@BUG MediumPriority - tvxx (1 of 2) ->|    public UnsupportedFileOperationException(FileOperation op) {
@BUG MediumPriority - tvxx (1 of 2) ->|        super();
