 ...
 */
@BUG LowPriority - hplx (3 of 3) ->|
@BUG LowPriority - hplx (3 of 3) ->|package com.mucommander.command;
@BUG LowPriority - hplx (3 of 3) ->|
 ...
 */
@BUG HighPriority - ruoc (1 of 1) ->|public class AssociationReader extends DefaultHandler implements AssociationsXmlConstants {
    // - Instance variables --------------------------------------------------
    // -----------------------------------------------------------------------
     ...
     */
@BUG MediumPriority - mvcq (1 of 2) ->|    public static void read(InputStream in, AssociationBuilder b) throws IOException, CommandException {
@BUG MediumPriority - mvcq (1 of 2) ->|        b.startBuilding();
