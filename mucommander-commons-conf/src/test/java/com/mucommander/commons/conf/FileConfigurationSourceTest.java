 ...
 */
@BUG LowPriority - ilgu (3 of 3) ->|
@BUG LowPriority - ilgu (3 of 3) ->|package com.mucommander.commons.conf;
@BUG LowPriority - ilgu (3 of 3) ->|
...
@BUG HighPriority - jaui (1 of 1) ->|    private static final String TEST_VALUE = "Hello, World!";
     ...
     */
@BUG MediumPriority - yvhz (1 of 2) ->|    @BeforeMethod
@BUG MediumPriority - yvhz (1 of 2) ->|    public void setUp() throws IOException {
