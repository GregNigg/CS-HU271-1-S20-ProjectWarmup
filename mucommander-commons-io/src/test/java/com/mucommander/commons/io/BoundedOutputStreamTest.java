 ...
 */
@BUG MediumPriority - toaz (2 of 2) ->|
@BUG MediumPriority - toaz (2 of 2) ->|package com.mucommander.commons.io;
...
public class BoundedOutputStreamTest {
     ...
     */
@BUG LowPriority - jtrx (1 of 3) ->|    @Test
@BUG LowPriority - jtrx (1 of 3) ->|    public void testBoundedStreamWithException() throws IOException {
@BUG LowPriority - jtrx (1 of 3) ->|        BoundedOutputStream bout = new BoundedOutputStream(new SinkOutputStream(), 4);
