@BUG LowPriority - phlx (3 of 3) ->|package com.mucommander.commons.file.protocol.local;
@BUG LowPriority - phlx (3 of 3) ->|
@BUG LowPriority - phlx (3 of 3) ->|import java.io.BufferedReader;
import java.io.File;
...
@BUG HighPriority - wnvn (1 of 1) ->|import com.mucommander.commons.file.protocol.local.LocalFile.LocalInputStream;
...
@BUG MediumPriority - yvdw (1 of 2) ->|import com.sun.jna.ptr.LongByReference;
@BUG MediumPriority - yvdw (1 of 2) ->|
/**
