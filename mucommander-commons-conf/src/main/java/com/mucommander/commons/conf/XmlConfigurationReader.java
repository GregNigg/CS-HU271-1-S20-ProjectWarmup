 ...
 */
@BUG LowPriority - zwii (3 of 3) ->|
@BUG LowPriority - zwii (3 of 3) ->|package com.mucommander.commons.conf;
@BUG LowPriority - zwii (3 of 3) ->|
import org.xml.sax.*;
 ...
 */
@BUG HighPriority - efrl (1 of 1) ->|public class XmlConfigurationReader extends DefaultHandler implements ConfigurationReader {
    // - Class fields --------------------------------------------------------------------------------------------------
    // -----------------------------------------------------------------------------------------------------------------
...
@BUG MediumPriority - rcwd (1 of 2) ->|    protected     ConfigurationBuilder builder;
@BUG MediumPriority - rcwd (1 of 2) ->|    /** Whether the current element is a variable. */
