 ...
 */
@BUG MediumPriority - ddpl (2 of 2) ->|
@BUG MediumPriority - ddpl (2 of 2) ->|
 ...
 */
@BUG LowPriority - rgba (1 of 3) ->|public interface PermissionBits {
@BUG LowPriority - rgba (1 of 3) ->|
@BUG LowPriority - rgba (1 of 3) ->|    /** read/write/execute permissions set for user/group/other (777 octal) */
