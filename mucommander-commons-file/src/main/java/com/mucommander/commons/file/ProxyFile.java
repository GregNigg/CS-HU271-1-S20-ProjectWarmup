 ...
 */
@BUG LowPriority - rgba (3 of 3) ->|
@BUG LowPriority - rgba (3 of 3) ->|
@BUG LowPriority - rgba (3 of 3) ->|package com.mucommander.commons.file;
 ...
 */
@BUG HighPriority - dszv (1 of 1) ->|public abstract class ProxyFile extends AbstractFile {
     ...
     */
@BUG MediumPriority - tgom (1 of 2) ->|    public AbstractFile getProxiedFile() {
@BUG MediumPriority - tgom (1 of 2) ->|        return file;
    }
