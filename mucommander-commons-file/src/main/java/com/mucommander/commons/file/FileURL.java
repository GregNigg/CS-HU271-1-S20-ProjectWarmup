 ...
 */
@BUG HighPriority - zwjn (1 of 1) ->|public class FileURL implements Cloneable {
...
@BUG MediumPriority - kvyb (1 of 2) ->|
@BUG MediumPriority - kvyb (1 of 2) ->|    /** Default handler for schemes that do not have a specific handler */
