 ...
 */
@BUG MediumPriority - tvxx (2 of 2) ->|
@BUG MediumPriority - tvxx (2 of 2) ->|
 ...
 */
@BUG LowPriority - uvly (1 of 3) ->|public abstract class AbstractArchiveEntryFile extends AbstractFile {
@BUG LowPriority - uvly (1 of 3) ->|
@BUG LowPriority - uvly (1 of 3) ->|    /** The archive file that contains this entry */
