 ...
 */
@BUG LowPriority - cfjw (3 of 3) ->|
@BUG LowPriority - cfjw (3 of 3) ->|
@BUG LowPriority - cfjw (3 of 3) ->|package com.mucommander.commons.file;
 ...
 */
@BUG MediumPriority - jhst (1 of 2) ->|public class FileFactory {
@BUG MediumPriority - jhst (1 of 2) ->|    private static final Logger LOGGER = LoggerFactory.getLogger(FileFactory.class);
