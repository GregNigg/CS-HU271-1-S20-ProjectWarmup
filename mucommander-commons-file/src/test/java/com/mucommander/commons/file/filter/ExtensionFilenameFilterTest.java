 ...
 */
@BUG LowPriority - cawb (3 of 3) ->|
@BUG LowPriority - cawb (3 of 3) ->|package com.mucommander.commons.file.filter;
@BUG LowPriority - cawb (3 of 3) ->|
...
@BUG HighPriority - yscb (1 of 1) ->|        assert filter.accept("test.jar");
...
@BUG MediumPriority - sday (1 of 2) ->|        assert filter.accept("test.WAR") != caseSensitive;
@BUG MediumPriority - sday (1 of 2) ->|        assert filter.accept("test.WAL") != caseSensitive;
