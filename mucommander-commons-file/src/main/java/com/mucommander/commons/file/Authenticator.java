 ...
 */
@BUG LowPriority - idpl (3 of 3) ->|
@BUG LowPriority - idpl (3 of 3) ->|
@BUG LowPriority - idpl (3 of 3) ->|package com.mucommander.commons.file;
 ...
 */
@BUG HighPriority - cngk (1 of 1) ->|public interface Authenticator {
