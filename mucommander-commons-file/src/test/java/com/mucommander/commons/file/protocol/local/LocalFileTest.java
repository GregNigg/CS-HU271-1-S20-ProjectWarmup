 ...
 */
@BUG MediumPriority - sday (2 of 2) ->|
@BUG MediumPriority - sday (2 of 2) ->|package com.mucommander.commons.file.protocol.local;
...
@BUG LowPriority - bfmu (1 of 3) ->|    }
@BUG LowPriority - bfmu (1 of 3) ->|
@BUG LowPriority - bfmu (1 of 3) ->|    @Override
    ...
    /**
     * Asserts that {@link com.mucommander.commons.file.protocol.local.LocalFile#getUserHome()} returns a file that is not null,
