 ...
 */
@BUG MediumPriority - jfra (2 of 2) ->|
@BUG MediumPriority - jfra (2 of 2) ->|package com.mucommander.commons.io.base64;
...
@BUG LowPriority - xemh (1 of 3) ->|
@BUG LowPriority - xemh (1 of 3) ->|        // On a Unicode sequence. Note that the string has been encoded using UTF-8 bytes.
@BUG LowPriority - xemh (1 of 3) ->|        testKnownSequence("どうもありがとうミスターロボット", "44Gp44GG44KC44GC44KK44GM44Go44GG44Of44K544K/44O844Ot44Oc44OD44OI");
    }
