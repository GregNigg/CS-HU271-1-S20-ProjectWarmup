 ...
 */
@BUG LowPriority - enfa (3 of 3) ->|
@BUG LowPriority - enfa (3 of 3) ->|
@BUG LowPriority - enfa (3 of 3) ->|package com.mucommander.commons.file.icon;
...
public interface FileIconProvider {
     ...
     */
@BUG HighPriority - nuzo (1 of 1) ->|    Icon getFileIcon(AbstractFile file, Dimension preferredResolution);
}
