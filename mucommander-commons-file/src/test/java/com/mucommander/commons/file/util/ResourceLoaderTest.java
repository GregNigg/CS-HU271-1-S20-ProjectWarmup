 ...
 */
@BUG MediumPriority - pmjb (2 of 2) ->|
@BUG MediumPriority - pmjb (2 of 2) ->|package com.mucommander.commons.file.util;
 ...
 */
@BUG LowPriority - fzwx (1 of 3) ->|public class ResourceLoaderTest {
@BUG LowPriority - fzwx (1 of 3) ->|
@BUG LowPriority - fzwx (1 of 3) ->|    /**
