 ...
 */
@BUG LowPriority - sfmh (3 of 3) ->|
@BUG LowPriority - sfmh (3 of 3) ->|package com.mucommander.commons.file.filter;
@BUG LowPriority - sfmh (3 of 3) ->|
...
public abstract class AbstractStringCriterionFilter extends AbstractCriterionFilter<String> implements StringCriterionFilter {
     ...
     */
@BUG HighPriority - jtjj (1 of 1) ->|    public AbstractStringCriterionFilter(CriterionValueGenerator<String> generator, boolean caseSensitive) {
...
@BUG MediumPriority - bzlg (1 of 2) ->|        this.caseSensitive = caseSensitive;
@BUG MediumPriority - bzlg (1 of 2) ->|    }
}
