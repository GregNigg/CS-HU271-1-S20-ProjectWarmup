 ...
 */
@BUG MediumPriority - xsmr (2 of 2) ->|
@BUG MediumPriority - xsmr (2 of 2) ->|
...
@BUG LowPriority - hqlv (1 of 3) ->|    String HDFS      = "hdfs";
@BUG LowPriority - hqlv (1 of 3) ->|
@BUG LowPriority - hqlv (1 of 3) ->|    /** Protocol for files served by a web server using HTTPS. */
    String HTTPS     = "https";
