 ...
 */
@BUG MediumPriority - xgqh (2 of 2) ->|
@BUG MediumPriority - xgqh (2 of 2) ->|package com.mucommander.commons.file.filter;
 ...
 */
@BUG LowPriority - swxt (1 of 3) ->|public interface FileFilter {
@BUG LowPriority - swxt (1 of 3) ->|
@BUG LowPriority - swxt (1 of 3) ->|    /**
