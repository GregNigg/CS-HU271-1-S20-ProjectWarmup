 ...
 */
@BUG LowPriority - zhxc (3 of 3) ->|
@BUG LowPriority - zhxc (3 of 3) ->|package com.mucommander.commons.file.util;
@BUG LowPriority - zhxc (3 of 3) ->|
...
public class PathUtilsTest {
     ...
     * @throws IOException should not happen
     */
@BUG HighPriority - ukrq (1 of 1) ->|    public void testResolveDestination(AbstractFile baseFolder) throws IOException {
...
@BUG MediumPriority - pmjb (1 of 2) ->|
@BUG MediumPriority - pmjb (1 of 2) ->|        int expectedType;
