 ...
 */
@BUG LowPriority - tcst (3 of 3) ->|
@BUG LowPriority - tcst (3 of 3) ->|package com.mucommander.auth;
@BUG LowPriority - tcst (3 of 3) ->|
...
@BUG HighPriority - pqyd (1 of 1) ->|
     ...
     */
@BUG MediumPriority - iwdf (1 of 2) ->|    public Credentials getCredentials() {
@BUG MediumPriority - iwdf (1 of 2) ->|        return credentials;
    }
