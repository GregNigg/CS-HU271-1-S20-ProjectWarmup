 ...
 */
@BUG LowPriority - knnu (3 of 3) ->|
@BUG LowPriority - knnu (3 of 3) ->|
@BUG LowPriority - knnu (3 of 3) ->|package com.mucommander.commons.file.util;
...
@BUG HighPriority - atjs (1 of 1) ->|    
    ...
    public static class STATVFSSTRUCT extends Structure {
        ...
        public int f_blocks;
        /* # free blocks */
@BUG MediumPriority - aums (1 of 2) ->|        public int f_bfree;
@BUG MediumPriority - aums (1 of 2) ->|        /* # free blocks for non-root */
        public int f_bavail;
        /* # inodes */
        public int f_files;
        /* # free inodes */
