 ...
 */
@BUG LowPriority - mxef (3 of 3) ->|
@BUG LowPriority - mxef (3 of 3) ->|package com.mucommander.commons.io;
@BUG LowPriority - mxef (3 of 3) ->|
 ...
 */
@BUG HighPriority - htvv (1 of 1) ->|public class RandomGeneratorInputStream extends InputStream {
    ...
    @Override
@BUG MediumPriority - jxxc (1 of 2) ->|    public int read() throws IOException {
@BUG MediumPriority - jxxc (1 of 2) ->|        return random.nextInt();
    }
