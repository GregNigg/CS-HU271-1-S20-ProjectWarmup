 ...
 */
@BUG MediumPriority - bfgq (2 of 2) ->|
@BUG MediumPriority - bfgq (2 of 2) ->|package com.mucommander.commons.io.compound;
 ...
 */
@BUG LowPriority - hjuf (1 of 3) ->|public class CompoundReaderTest {
@BUG LowPriority - hjuf (1 of 3) ->|
@BUG LowPriority - hjuf (1 of 3) ->|    /** Test strings */
