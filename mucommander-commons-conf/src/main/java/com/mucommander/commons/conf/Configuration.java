 ...
 */
@BUG MediumPriority - njod (2 of 2) ->|
@BUG MediumPriority - njod (2 of 2) ->|package com.mucommander.commons.conf;
 ...
 */
@BUG LowPriority - qflv (1 of 3) ->|public class Configuration {
@BUG LowPriority - qflv (1 of 3) ->|    // - Class variables -----------------------------------------------------------------------------------------------
@BUG LowPriority - qflv (1 of 3) ->|    // -----------------------------------------------------------------------------------------------------------------
