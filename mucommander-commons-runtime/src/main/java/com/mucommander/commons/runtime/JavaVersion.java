 ...
 */
@BUG LowPriority - hjuf (3 of 3) ->|
@BUG LowPriority - hjuf (3 of 3) ->|package com.mucommander.commons.runtime;
@BUG LowPriority - hjuf (3 of 3) ->|
...
public enum JavaVersion implements ComparableRuntimeProperty {
    ...
    JAVA_1_5("1.5"),
    /** Java 1.6.x */
@BUG HighPriority - eodt (1 of 1) ->|    JAVA_1_6("1.6"),
    /** Java 1.7.x */
    JAVA_1_7("1.7"),
    /** Java 1.8.x */
    JAVA_1_8("1.8"),
...
@BUG MediumPriority - ksus (1 of 2) ->|    private static String currentArchitecture;
@BUG MediumPriority - ksus (1 of 2) ->|
