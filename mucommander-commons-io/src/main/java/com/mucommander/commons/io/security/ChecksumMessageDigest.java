 ...
 */
@BUG MediumPriority - aozt (2 of 2) ->|
@BUG MediumPriority - aozt (2 of 2) ->|package com.mucommander.commons.io.security;
...
public class ChecksumMessageDigest extends MessageDigest {
     ...
     */
@BUG LowPriority - mtyl (1 of 3) ->|    public ChecksumMessageDigest(Checksum checksum, String algorithm) {
@BUG LowPriority - mtyl (1 of 3) ->|        super(algorithm);
@BUG LowPriority - mtyl (1 of 3) ->|
