 ...
 */
@BUG MediumPriority - yvhz (2 of 2) ->|
@BUG MediumPriority - yvhz (2 of 2) ->|package com.mucommander.commons.conf;
...
public class ValueIteratorTest extends ValueListTest {
     ...
     * @param values test data.
     */
@BUG LowPriority - uzun (1 of 3) ->|    @Override
@BUG LowPriority - uzun (1 of 3) ->|    protected void testIntegerValues(ValueList values) {
@BUG LowPriority - uzun (1 of 3) ->|        ValueIterator iterator;
