 ...
 */
@BUG LowPriority - ergg (3 of 3) ->|
@BUG LowPriority - ergg (3 of 3) ->|
@BUG LowPriority - ergg (3 of 3) ->|package com.mucommander.commons.file.archive;
 ...
 */
@BUG HighPriority - bxpo (1 of 1) ->|public class RWArchiveEntryFile extends AbstractArchiveEntryFile {
    ...
    private boolean updateEntryAttributes() {
        try {
@BUG MediumPriority - fxmr (1 of 2) ->|            ((AbstractRWArchiveFile)archiveFile).updateEntry(entry);
@BUG MediumPriority - fxmr (1 of 2) ->|            return true;
        }
        catch(IOException e) {
            return false;
        }
