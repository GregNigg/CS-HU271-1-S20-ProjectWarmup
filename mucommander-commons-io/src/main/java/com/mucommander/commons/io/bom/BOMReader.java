 ...
 */
@BUG MediumPriority - zpbk (2 of 2) ->|
@BUG MediumPriority - zpbk (2 of 2) ->|package com.mucommander.commons.io.bom;
...
public class BOMReader extends InputStreamReader {
     ...
     */
@BUG LowPriority - nggd (1 of 3) ->|    public BOMReader(InputStream in) throws IOException {
@BUG LowPriority - nggd (1 of 3) ->|        this(new BOMInputStream(in), "UTF-8");
@BUG LowPriority - nggd (1 of 3) ->|    }
