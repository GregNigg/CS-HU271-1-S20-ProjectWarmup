 ...
 */
@BUG LowPriority - ajgi (3 of 3) ->|
@BUG LowPriority - ajgi (3 of 3) ->|package com.mucommander;
@BUG LowPriority - ajgi (3 of 3) ->|
 ...
 */
@BUG HighPriority - pvik (1 of 1) ->|public class VersionChecker extends DefaultHandler {
...
@BUG MediumPriority - iwld (1 of 2) ->|    public static final int STATE_UNKNOWN      = 5;
@BUG MediumPriority - iwld (1 of 2) ->|
