 ...
 */
@BUG LowPriority - nggd (3 of 3) ->|
@BUG LowPriority - nggd (3 of 3) ->|package com.mucommander.commons.io.compound;
@BUG LowPriority - nggd (3 of 3) ->|
...
@BUG HighPriority - jgmc (1 of 1) ->|    private boolean merged;
     ...
     */
@BUG MediumPriority - ppvt (1 of 2) ->|    public boolean isMerged() {
@BUG MediumPriority - ppvt (1 of 2) ->|        return merged;
    }
