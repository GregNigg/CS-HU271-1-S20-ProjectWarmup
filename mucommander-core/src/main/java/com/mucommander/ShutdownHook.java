 ...
 */
@BUG MediumPriority - wloc (2 of 2) ->|
@BUG MediumPriority - wloc (2 of 2) ->|package com.mucommander;
 ...
 */
@BUG LowPriority - ajgi (1 of 3) ->|public class ShutdownHook extends Thread {
@BUG LowPriority - ajgi (1 of 3) ->|    private static final Logger LOGGER = LoggerFactory.getLogger(ShutdownHook.class);
@BUG LowPriority - ajgi (1 of 3) ->|
