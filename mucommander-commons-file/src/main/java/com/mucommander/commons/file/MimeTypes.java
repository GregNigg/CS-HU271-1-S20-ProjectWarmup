 ...
 */
@BUG MediumPriority - njjs (2 of 2) ->|
@BUG MediumPriority - njjs (2 of 2) ->|
 ...
 */
@BUG LowPriority - pcng (1 of 3) ->|public class MimeTypes extends Hashtable<String, String> {
@BUG LowPriority - pcng (1 of 3) ->|
@BUG LowPriority - pcng (1 of 3) ->|    private final static MimeTypes mimeTypes = new MimeTypes();
