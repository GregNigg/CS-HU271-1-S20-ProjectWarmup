 ...
 */
@BUG MediumPriority - wpyx (2 of 2) ->|
@BUG MediumPriority - wpyx (2 of 2) ->|package com.mucommander.commons.file.filter;
...
public abstract class AbstractRegexpFilter extends AbstractStringCriterionFilter {
     ...
     */
@BUG LowPriority - sfmh (1 of 3) ->|    public AbstractRegexpFilter(CriterionValueGenerator<String> generator, String regexp, boolean caseSensitive, boolean inverted) throws PatternSyntaxException {
@BUG LowPriority - sfmh (1 of 3) ->|        super(generator, caseSensitive, inverted);
@BUG LowPriority - sfmh (1 of 3) ->|
