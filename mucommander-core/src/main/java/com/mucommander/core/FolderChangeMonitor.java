 ...
 */
@BUG LowPriority - orzr (3 of 3) ->|
@BUG LowPriority - orzr (3 of 3) ->|package com.mucommander.core;
@BUG LowPriority - orzr (3 of 3) ->|
...
@BUG HighPriority - ofma (1 of 1) ->|import com.mucommander.conf.MuPreference;
...
@BUG MediumPriority - pmrs (1 of 2) ->|
@BUG MediumPriority - pmrs (1 of 2) ->|    /** Current file table's folder */
