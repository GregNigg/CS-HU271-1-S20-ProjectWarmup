 ...
 */
@BUG MediumPriority - amvj (2 of 2) ->|
@BUG MediumPriority - amvj (2 of 2) ->|package com.mucommander.commons.io;
 ...
 */
@BUG LowPriority - mxef (1 of 3) ->|public abstract class RandomAccessInputStream extends InputStream implements RandomAccess {
@BUG LowPriority - mxef (1 of 3) ->|    /** Logger used by this class. */
@BUG LowPriority - mxef (1 of 3) ->|    private static final Logger LOGGER = LoggerFactory.getLogger(RandomAccessInputStream.class);
