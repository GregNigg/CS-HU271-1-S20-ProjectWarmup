 ...
 */
@BUG LowPriority - ernd (3 of 3) ->|
@BUG LowPriority - ernd (3 of 3) ->|
@BUG LowPriority - ernd (3 of 3) ->|package com.mucommander.commons.util.ui.dialog;
...
@BUG MediumPriority - enwy (1 of 2) ->|        int maxWidth = (int)d.getWidth();
@BUG MediumPriority - enwy (1 of 2) ->|        int maxHeight = (int)d.getHeight();
