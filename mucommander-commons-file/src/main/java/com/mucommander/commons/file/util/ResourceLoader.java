 ...
 */
@BUG LowPriority - bqzt (3 of 3) ->|
@BUG LowPriority - bqzt (3 of 3) ->|
@BUG LowPriority - bqzt (3 of 3) ->|package com.mucommander.commons.file.util;
...
@BUG HighPriority - fjne (1 of 1) ->|import java.net.URL;
 ...
 */
@BUG MediumPriority - rhhu (1 of 2) ->|public class ResourceLoader {
@BUG MediumPriority - rhhu (1 of 2) ->|    private static final Logger LOGGER = LoggerFactory.getLogger(ResourceLoader.class);
